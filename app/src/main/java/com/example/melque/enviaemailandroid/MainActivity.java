...
/**/
/**/
package com.example.melque.enviaemailandroid;
    ...
    public void onClick(View v) {
        ...
        session = Session.getDefaultInstance(props, new Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("Email@qualquer", "Senhaquevccolocar");
            }
        });

        pdialog = ProgressDialog.show(context, "", "Enviando Email... Aguarde!", true);
